#### Bank of questions to explore:

1. What portion of highest rated books are sequels?
2. Which publisher has on balance the highest ratings?
...
- Authors with or without social media presence? Does it affect sales/visibility/publication possibility nowadays?
- Difference between ratings on Goodreads versus ratings on Storygraph (+ Pagebound, Fable etc.)
    - Is Goodreads rating affected by the fact that it's connected to Amazon and people get prompted after purchase or finishing the book on Kindle?
    - Is there a way to know demographic of storygraph?
